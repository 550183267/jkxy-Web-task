...
<div class="list-group">
            <a href="#" id="addnews" class="btn btn-primary" data-toggle="modal" data-target="#myModal">添加新闻</a>
            <!-- 添加新闻 -->
    ...
    <table class="table table-hover table-bordered table-condensed table-striped">
        ...
        ?>
            <tr>
                ...
                <td><a href="../php/updatenews.php?id=<?php echo $row['id'] ?>" class="edit">修改</a>
                <a href="../php/deletenews.php?id=<?php echo $row['id'] ?>" class="edit">删除</a>
                </td>
            </tr>
        <?php
        }
